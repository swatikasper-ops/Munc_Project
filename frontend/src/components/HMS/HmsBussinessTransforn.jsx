...
const HmsBussinessTransforn = () => {

  const [showForm, setShowForm] = useState(false); // ✅ YE MISSING THA
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center px-6 md:px-12 text-white z-10">
            <div className="flex flex-col gap-3 max-w-[600px]">
              ...
              {/* BUTTON */}
              <button
                onClick={() => setShowForm(true)} // ✅ ab error nahi aayega
...
export default HmsBussinessTransforn;